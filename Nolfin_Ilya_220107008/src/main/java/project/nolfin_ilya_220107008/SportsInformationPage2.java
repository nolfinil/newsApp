...
public class SportsInformationPage2 {
    ...
    void mouseHovering(){
        ...
        label4.setOnMouseMoved(event -> {
            newsImage4.setFitHeight(155);
            newsImage4.setFitWidth(270);
        ...
        label4.setOnMouseExited(event -> {
            newsImage4.setFitHeight(150);
            newsImage4.setFitWidth(265);
